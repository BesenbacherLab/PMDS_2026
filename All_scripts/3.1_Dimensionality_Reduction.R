...
depmap_data <- read.csv("Data/depmap_export_2025-12-01_13_24_31.776975_subsetted.csv")
glimpse(depmap_data)
...
depmap_data <- depmap_data |> drop_na()
...
# EXERCISE C: Use geom_col. to create a bar plot showing variance explained by each PC
...
# Exercise D: Create a plot showing the accumulated variance explained by PCs
...
# EXERCISE D: 
# The plot below is another PCA plot (PC1 vs PC2) colored by lineage_1 similar to Exercise A.
# Can you figure out what the effect of the alpha parameter is?
...
# EXERCISE F: Use write_tsv to save the data with PCA coordinates (depmap_with_pca)
# to a file called "Data/depmap_w_pca_SAVED.tsv"
